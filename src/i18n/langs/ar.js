...
const ar = {
  common: {
    ...
    howItWorkLYF3: "• القدرة على ضبط النطاق السعري لصناعة سوق CLMM تلقائيًا لمنع الأسعار من عبور الحدود وزيادة العائدات",
    howItWorkLendTitle: "الإقراض",
    howItWorkLend1: "• يقوم المستخدمون بالإيداع في مجمعات الإقراض للحصول على عوائد من المقترضين",
    howItWorkLend2: "• لن يوفر الإقراض الرموز المميزة للبروتوكولات الخارجية الأخرى. إنها تقرض فقط الرموز المميزة لمزارع وأموال Apoy ذات الإنتاجية العالية. لا يجوز سحب الرموز المقترضة. ولا يشترط وجود ضمانات عند الاقتراض.",
    howItWorkAMFTitle: "صناديق إدارة الأصول",
    howItWorkAMF1: "• إدارة المراكز تلقائيًا في مزارع الدخل ذات الرافعة المالية للمستخدمين، باستخدام خوارزميات الذكاء الاصطناعي لتحقيق أفضل توازن بين المخاطر والعائد",
    howItWorkAMF2: "• هناك مجموعة متنوعة من الصناديق لتلبية احتياجات إدارة الأصول المختلفة. مثل صناديق السندات، وصناديق التحوط، وصناديق المؤشرات، وما إلى ذلك",
    howItWorkAMF3: "",
