...
const ar = {
  common: {
    ...
    discord: "Discord",
    telegram: "Telegram",
    carouselCard1: "ستكون Apoy Finance متاحة على شبكة الاختبار في يناير 2024. وتتفاوض Apoy Finance الآن مع السلاسل النسبية. سيتم الإعلان عن السلسلة التي سيتم إطلاقها لاحقًا.",
    carouselCard2: "ستقوم Apoy Finance بنشر المهام للمستخدمين في Discord. يمكنك الانضمام لكسب المكافآت من خلال إنجاز المهام.",
    carouselCard3: "تقدم Apoy Finance مجموعة متنوعة من المناصب، بما في ذلك المشرف والسفير وتطوير الأعمال والمهندس. انضم إلى خادم Discord للتقديم.",
    carouselCard4: "ترحب Apoy Finance بجميع أنواع التعاون، بما في ذلك على سبيل المثال لا الحصر، المجتمع والأمن والإعلام ورأس المال وصناع السوق والمزيد.",
