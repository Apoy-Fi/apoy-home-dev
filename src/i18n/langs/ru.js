...
const ru = {
  common: {
    ...
    howItWorkLYF3: "• Возможность автоматической корректировки ценового диапазона рыночного процесса CLMM, чтобы предотвратить пересечение цен ценами и повысить доходность.",
    ...
    howItWorkLend2: "• Кредитование не будет предоставлять токены другим внешним протоколам. Он предоставляет токены только доходным фермам и фондам Apoy с кредитным плечом. Вывод заемных токенов не допускается. При получении кредита залог не требуется.",
    howItWorkAMFTitle: "Фонды управления активами",
    howItWorkAMF1: "• Автоматически управляйте позициями в фермах с заемным доходом для пользователей, используя алгоритмы искусственного интеллекта для достижения наилучшего баланса между риском и доходностью.",
    howItWorkAMF2: "• Существует множество фондов для удовлетворения различных потребностей в управлении активами. Например, фонды облигаций, хедж-фонды, индексные фонды и т. д.",
    howItWorkAMF3: "",
