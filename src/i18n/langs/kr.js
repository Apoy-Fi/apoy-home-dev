...
const kr = {
  common: {
    ...
    howItWorkLYF3: "• CLMM 마켓 메이킹 가격 범위를 자동으로 조정하여 가격이 경계를 넘지 않도록 방지하고 수익률을 높일 수 있습니다.",
    howItWorkLendTitle: "대출",
    howItWorkLend1: "• 사용자는 대출자로부터 수익을 얻기 위해 대출 풀에 예금합니다.",
    howItWorkLend2: "• 대출은 다른 외부 프로토콜에 토큰을 공급하지 않습니다. Apoy를 활용한 수확량 농장과 자금에만 토큰을 빌려줍니다. 빌린 토큰은 출금할 수 없습니다. 대출시 담보에 비해 필요하지 않습니다.",
    howItWorkAMFTitle: "자산운용자금",
    howItWorkAMF1: "• 위험과 수익 간의 최상의 균형을 달성하기 위해 인공 지능 알고리즘을 사용하여 사용자를 위한 레버리지 소득 농장의 포지션을 자동으로 관리합니다.",
    howItWorkAMF2: "• 다양한 자산관리 요구를 충족시킬 수 있는 다양한 펀드가 있습니다. 채권형펀드, 헤지펀드, 인덱스펀드 등이 대표적이다.",
    howItWorkAMF3: "",
