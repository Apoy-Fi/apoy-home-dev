...
const sp = {
  common: {
    ...
    howItWorkLYF3: "• Capaz de ajustar automáticamente el rango de precios de la creación de mercado CLMM para evitar que los precios crucen el límite y aumentar los rendimientos.",
    ...
    howItWorkLend2: "• Los préstamos no proporcionarán tokens a otros protocolos externos. Solo presta tokens a fondos y granjas de rendimiento apalancados de Apoy. No está permitido retirar los tokens prestados. No se requiere garantía adicional al pedir prestado.",
    howItWorkAMFTitle: "Fondos de gestión de activos",
    howItWorkAMF1: "• Gestionar automáticamente posiciones en granjas de ingresos apalancadas para los usuarios, utilizando algoritmos de inteligencia artificial para lograr el mejor equilibrio entre riesgo y rendimiento.",
    howItWorkAMF2: "• Existe una variedad de fondos para satisfacer diferentes necesidades de gestión de activos. Como fondos de bonos, fondos de cobertura, fondos indexados, etc.",
    howItWorkAMF3: "",
