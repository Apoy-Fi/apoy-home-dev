...
const jp = {
  common: {
    ...
    discord: "Discord",
    telegram: "Telegram",
    carouselCard1: "Apoy Finance は 2024 年 1 月にテストネットに登場します。Apoy Finance は現在、関連チェーンと交渉中です。 どのチェーンで開始するかは後ほど発表します。",
    carouselCard2: "Apoy Finance は Discord でユーザーのタスクを公開します。 タスクを達成することで報酬を獲得するために参加できます。",
    carouselCard3: "Apoy Finance では、モデレーター、アンバサダー、ビジネス開発、エンジニアなど、さまざまなポジションを提供しています。 Discordサーバーに参加して応募してください。",
    carouselCard4: "Apoy Finance は、コミュニティ、セキュリティ、メディア、資本、マーケットメーカーなどを含むがこれらに限定されない、あらゆる種類の協力を歓迎します。",
