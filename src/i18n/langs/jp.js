...
const jp = {
  common: {
    ...
    howItWorkLYF3: "• CLMM マーケットメイクの価格範囲を自動的に調整して、価格が境界を越えるのを防ぎ、利回りを向上させることができます.",
    howItWorkLendTitle: "貸し出し",
    howItWorkLend1: "• ユーザーは融資プールに預けて借り手から利益を得ます.",
    howItWorkLend2: "• レンディングは他の外部プロトコルにトークンを供給しません。 Apoyレバレッジイールドファームとファンドにのみトークンを貸し出します。借りたトークンを引き出すことはできません。借入の際に担保は必要ありません。",
    howItWorkAMFTitle: "資産運用ファンド",
    howItWorkAMF1: "• 人工知能アルゴリズムを使用して、ユーザーのレバレッジド・インカム・ファームのポジションを自動的に管理し、リスクとリターンの最適なバランスを実現します.",
    howItWorkAMF2: "• さまざまな資産運用ニーズに対応するさまざまなファンドがあります。債券ファンド、ヘッジファンド、インデックスファンドなど.",
    howItWorkAMF3: "",
