        ...
        <el-row id="header" type="flex" align="middle" justify="space-between" class="header f-main f-1vw">
          ...
          <el-col :span="8">
            <el-row type="flex" align="middle" justify="end">
              ...
              <button class="Btn-Launch f-1vw" style="width: 120px; height: 40px;" @click="go(urls.dapp)">
                {{ $t("common.launchApp") }}
              </button>
      ...
      <el-main style="overflow: hidden;">
        ...
        <div class="main-f">
          ...
          <div v-show="show_home" class="animate__animated animate__fadeInRight"
            ...
            <button class="Btn-Launch f-1_2vw" style="width: 170px; height: 45px;" @click="go(urls.dapp)">
              {{ $t("common.launchApp") }}
            </button>
          </div>
