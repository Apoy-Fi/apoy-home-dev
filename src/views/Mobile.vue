  ...
  <div id="mobile" class="mobile">
    ...
    <el-container>
        ...
        <el-row id="header" v-show="show_header" type="flex" align="middle" justify="space-between"
          ...
          <el-col :span="8">
            <el-row type="flex" align="middle" justify="end">
              ...
              <div class="ml-10">
                <button class="Btn-Launch f-12" style="width: 80px; height: 35px;" @click="go(urls.dapp)">
                  {{ $t("common.launchApp") }}
                </button>
              </div>
      ...
      <el-drawer :visible.sync="drawer" :with-header="false" size="60%">
        ...
        <div class="ml-10">
          <button class="Btn-Launch f-12" style="width: 150px; height: 50px;" @click="go(urls.dapp)">
            {{ $t("common.launchApp") }}
          </button>
        </div>
      ...
      <el-main style="overflow: hidden;">
        <div class="main-f">
          ...
          <div v-show="show_home" class="animate__animated animate__fadeInRight"
            ...
            <button class="Btn-Launch f-20" style="width: 30vw; height: 45px; top: 130px" @click="go(urls.dapp)">
              {{ $t("common.launchApp") }}
            </button>
          </div>
      ...
      <el-footer id="footer" height="450px" class="darkAmber">
        ...
        <el-row class="ml-5">
          ...
          <el-row class="mt-30 f-16 f-weighter">
            ...
            <el-row>
              <span @click="go(urls.dapp)">{{ $t('common.launchApp') }}</span>
            </el-row>
          </el-row>
        </el-row>
